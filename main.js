...
var $author$project$Main$recalculateFromIso = function (model) {
	var parsedMillis = A2(
		$elm$core$Result$map,
		$elm$time$Time$posixToMillis,
		A2($elm$json$Json$Decode$decodeString, $rtfeldman$elm_iso8601_date_strings$Iso8601$decoder, '\"' + (model.isoDate + '\"')));
	if (parsedMillis.$ === 'Ok') {
		var millis = parsedMillis.a;
		var time = $elm$time$Time$millisToPosix(millis);
		var toInput = function (accessor) {
			return $elm$core$String$fromInt(
				A2(accessor, $elm$time$Time$utc, time));
		};
		var _v1 = $author$project$Main$posixToClarion(time);
		var clarionDate = _v1.clarionDate;
		var clarionTime = _v1.clarionTime;
		return _Utils_update(
			model,
			{
				...
				month: $elm$core$String$fromInt(
					$author$project$Main$monthToNumber(
		...
		return _Utils_Tuple2(
			function () {
				switch (msg.$) {
					case 'IsoDateInput':
						...
						return $author$project$Main$recalculateFromIso(
							_Utils_update(
								model,
								{isoDate: str}));
					case 'ClarionDateInput':
						var str = msg.a;
						return $author$project$Main$recalculateFromClarion(
							_Utils_update(
								model,
								{clarionDate: str}));
					case 'ClarionTimeInput':
						var str = msg.a;
						return $author$project$Main$recalculateFromClarion(
							_Utils_update(
								model,
					...
					case 'DateInput':
						var str = msg.a;
						return $author$project$Main$recalculateFromHuman(
							_Utils_update(
								model,
								{date: str}));
					case 'MonthInput':
...
var $author$project$Main$ClarionDateInput = function (a) {
	return {$: 'ClarionDateInput', a: a};
};
var $author$project$Main$ClarionTimeInput = function (a) {
	return {$: 'ClarionTimeInput', a: a};
};
var $author$project$Main$DateInput = function (a) {
	return {$: 'DateInput', a: a};
};
var $author$project$Main$HourInput = function (a) {
	return {$: 'HourInput', a: a};
};
var $author$project$Main$IsoDateInput = function (a) {
	return {$: 'IsoDateInput', a: a};
};
var $author$project$Main$MinuteInput = function (a) {
	return {$: 'MinuteInput', a: a};
};
var $author$project$Main$MonthInput = function (a) {
	return {$: 'MonthInput', a: a};
};
var $author$project$Main$SecondInput = function (a) {
	return {$: 'SecondInput', a: a};
};
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		init: $author$project$Main$initModel,
